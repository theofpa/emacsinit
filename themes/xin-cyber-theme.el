...
(custom-theme-set-faces
 ...
 '(font-lock-function-name-face ((t (:foreground "tomato" :weight bold))))
 ...
 '(mode-line ((t (:box (:line-width -1 :color nil :style released-button) :foreground "#8FB28F" :background "#333333"))))
